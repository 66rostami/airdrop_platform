...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2025 at 11:58 PM
...
INSERT INTO `users` (`id`, `wallet_address`, `total_points`, `referral_code`, `referred_by`, `created_at`, `last_login`, `level`, `profile_completed`, `telegram_username`, `twitter_username`, `discord_username`, `is_banned`, `ban_reason`, `email`, `verified_at`, `banned_at`, `banned_by`, `updated_at`, `username`, `status`) VALUES
(1, '0x2102437e208b9e8284a0a1edb99f1e11f29732f6', 0, 'ENU05EHL', NULL, '2025-01-29 20:17:56', '2025-01-29 22:44:07', 1, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2025-01-31 02:26:46', 'user_0x2102...32f6', 'active');
...
--
ALTER TABLE `referral_history`
  ADD CONSTRAINT `referral_history_ibfk_1` FOREIGN KEY (`referrer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `referral_history_ibfk_2` FOREIGN KEY (`referred_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
